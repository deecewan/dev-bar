...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fs = __webpack_require__(335);

	var _fs2 = _interopRequireDefault(_fs);

	var _path = __webpack_require__(338);
	...
	var _onHeaders = __webpack_require__(337);

	var _onHeaders2 = _interopRequireDefault(_onHeaders);

	var _onFinished = __webpack_require__(336);

	var _onFinished2 = _interopRequireDefault(_onFinished);

	var _chalk = __webpack_require__(334);
	...
	var io = new _socket2.default(process.env.SOCKET_PORT || 3001, { serveClient: false });
	...
	function devMode(devDetails) {
	  ...
	  return function (req, res, next) {
	    ...
	    (0, _onHeaders2.default)(res, function setResHeadersThing() {
	      if (!req.devStarted) {
	        return;
	      }
	      this.devStarted = process.hrtime();
	      var ms = (this.devStarted[0] - req.devStarted[0]) * 1e3 + (this.devStarted[1] - req._startAt[1]) * 1e-6;
	      developerDetails.req = ms.toFixed(3);
	    });
	    (0, _onFinished2.default)(res, _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	      var t, ms, branchName;
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              if (res.devStarted) {
	                t = process.hrtime();
	                ms = (t[0] - res.devStarted[0]) * 1e3 + (t[1] - res.devStarted[1]) * 1e-6;
	              ...
	              _context.prev = 1;
	              _context.next = 4;
	              return asyncFileRead(_path2.default.resolve('.git', 'HEAD'));
	            ...
	            case 8:
	              ...
	              console.warn("Couldn't open git ref head", _context.t0);
	    ...
	    if (devDetails && (typeof devDetails === 'undefined' ? 'undefined' : _typeof(devDetails)) !== 'object') {
	      console.warn(_chalk2.default.orange.bold('devDetails should be an object'));
	    }
	    Object.entries(devDetails).forEach(function (_ref2) {
	      var _ref3 = _slicedToArray(_ref2, 2),
	          key = _ref3[0],
	          value = _ref3[1];

	      var v = typeof value === 'function' ? value(req, res) : value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DevToolbar = exports.middleware = undefined;

	var _expressMiddleware = __webpack_require__(317);

	var _expressMiddleware2 = _interopRequireDefault(_expressMiddleware);

	var _DevToolbar = __webpack_require__(316);

	var _DevToolbar2 = _interopRequireDefault(_DevToolbar);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _expressMiddleware2.default;
	exports.middleware = _expressMiddleware2.default;
	exports.DevToolbar = _DevToolbar2.default;
